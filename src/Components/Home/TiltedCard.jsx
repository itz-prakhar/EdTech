...
const TiltedCard = () => {
  return (
    <div className='flex w-11/12  flex-col justify-center items-center text-center'>
    ...
    <div className='flex  flex-col justify-start items-center mt-5 lg:flex-row animate-float'>
        <img className='w-[26rem] ' src={img1}></img>
        <img className='w-[26rem] lg:mx-[-6rem]' src={img2}></img>
        <img className='w-[26rem] mt-[-3rem] ml-[-2rem]' src={img3}></img>
    </div>
